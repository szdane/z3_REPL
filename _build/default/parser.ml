...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState05 : (('s, _menhir_box_main) _menhir_cell1_FORALL, _menhir_box_main) _menhir_state
    (** State 05.
        Stack shape : FORALL.
        Start symbol: main. *)

  | MenhirState11 : (('s, _menhir_box_main) _menhir_cell1_VAR _menhir_cell0_var_type, _menhir_box_main) _menhir_state
    (** State 11.
        Stack shape : VAR var_type.
        Start symbol: main. *)

  | MenhirState14 : ((('s, _menhir_box_main) _menhir_cell1_FORALL, _menhir_box_main) _menhir_cell1_vars, _menhir_box_main) _menhir_state
    (** State 14.
        Stack shape : FORALL vars.
        Start symbol: main. *)

  | MenhirState16 : (('s, _menhir_box_main) _menhir_cell1_EXISTS, _menhir_box_main) _menhir_state
    (** State 16.
        Stack shape : EXISTS.
        Start symbol: main. *)

  | MenhirState18 : ((('s, _menhir_box_main) _menhir_cell1_EXISTS, _menhir_box_main) _menhir_cell1_vars, _menhir_box_main) _menhir_state
    (** State 18.
...
and 's _menhir_cell0_var_type = 
  | MenhirCell0_var_type of 's * (Ast.var_type)

and ('s, 'r) _menhir_cell1_vars = 
  | MenhirCell1_vars of 's * ('s, 'r) _menhir_state * ((string * Ast.var_type) list)
...
include struct
    ...
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s ->
      ...
      | COLON ->
          ...
          | INT_TYPE ->
              ...
              _menhir_goto_var_type _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok
          | BOOL_TYPE ->
              let _tok = _menhir_lexer _menhir_lexbuf in
  ...
  and _menhir_goto_var_type : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_VAR -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      match (_tok : MenhirBasics.token) with
      | COMMA ->
          let _menhir_stack = MenhirCell0_var_type (_menhir_stack, _v) in
      ...
      | LPAREN ->
          ...
          let t = _v in
          let _v = _menhir_action_24 t v in
          _menhir_goto_vars _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s
      | _ ->
          _eRR ()
  
  and _menhir_goto_vars : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s ->
      match _menhir_s with
      | MenhirState16 ->
  ...
  and _menhir_run_17 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_EXISTS as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s ->
  ...
  and _menhir_run_13 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_FORALL as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s ->
      let _menhir_stack = MenhirCell1_vars (_menhir_stack, _menhir_s, _v) in
  ...
  and _menhir_run_12 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_VAR _menhir_cell0_var_type -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v ->
      let MenhirCell0_var_type (_menhir_stack, t) = _menhir_stack in
      let MenhirCell1_VAR (_menhir_stack, _menhir_s, v) = _menhir_stack in
      let vs = _v in
      let _v = _menhir_action_25 t v vs in
      _menhir_goto_vars _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s
  ...
  and _menhir_run_48 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_NOT -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
  ...
  and _menhir_run_46 : type  ttv_stack. (((ttv_stack, _menhir_box_main) _menhir_cell1_FORALL, _menhir_box_main) _menhir_cell1_vars as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
      ...
      | RPAREN ->
          let _tok = _menhir_lexer _menhir_lexbuf in
          let MenhirCell1_vars (_menhir_stack, _, vs) = _menhir_stack in
          let MenhirCell1_FORALL (_menhir_stack, _menhir_s) = _menhir_stack in
          let e = _v in
          let _v = _menhir_action_20 e vs in
          _menhir_goto_quantifier_expr _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | PLUS ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_24 _menhir_stack _menhir_lexbuf _menhir_lexer
      | OR ->
  ...
  and _menhir_goto_quantifier_expr : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      let _1 = _v in
  ...
  and _menhir_run_41 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | DIVIDE ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_26 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | EOF | EQ | GE | GT | LE | LT | NEQ | OR | RPAREN ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1) = _menhir_stack in
          let e2 = _v in
  ...
  and _menhir_run_33 : type  ttv_stack. ((ttv_stack, _menhir_box_main) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      ...
      | DIVIDE ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_26 _menhir_stack _menhir_lexbuf _menhir_lexer
      | AND | EOF | EQ | GE | GT | LE | LT | MINUS | NEQ | OR | PLUS | RPAREN ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1) = _menhir_stack in
          let e2 = _v in
  ...
  and _menhir_run_27 : type  ttv_stack. (ttv_stack, _menhir_box_main) _menhir_cell1_expr -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_expr (_menhir_stack, _menhir_s, e1) = _menhir_stack in
      let e2 = _v in
  ...
  and _menhir_run_20 : type  ttv_stack. (((ttv_stack, _menhir_box_main) _menhir_cell1_EXISTS, _menhir_box_main) _menhir_cell1_vars as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | TIMES ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
      ...
      | RPAREN ->
          ...
          let e = _v in
          let _v = _menhir_action_21 e vs in
          _menhir_goto_quantifier_expr _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
      | PLUS ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v) in
          _menhir_run_24 _menhir_stack _menhir_lexbuf _menhir_lexer
